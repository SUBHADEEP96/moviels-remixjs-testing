...
export const meta: MetaFunction = () => {
  return [
    { title: "Movie List" },
    { name: "description", content: "Movie Lists" },
  ];
};
  ...
  return (
    <div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
          {data?.results?.map((movie: any) => (
            ...
            >
              <Link
                prefetch="intent"
                className="group relative overflow-hidden  block h-48  bg-gray-100 md:h-64"
